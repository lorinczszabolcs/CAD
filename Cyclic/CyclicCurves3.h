...
namespace cagd
{
    ...
    protected:
        ...
        GLdouble _CalculateNormalizingCoefficients(GLuint n);

        GLvoid   _CalculateBinomialCoefficients(GLuint n, TriangularMatrix<GLdouble> &bc);

    public:
        // special constructor
        CyclicCurve3(GLuint n, GLenum data_usage_flag = GL_STATIC_DRAW);

        // redeclare and define inherited virtual methods
