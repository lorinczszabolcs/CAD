...
GLboolean ShaderProgram::SetUniformVariableMatrix2fv  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3fv  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4fv  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix2x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix2x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix3x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariableMatrix4x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value)
{
    if (!_program)
        return GL_FALSE;
