...
namespace cagd
{
    ...
    public:
        ...
        GLboolean SetUniformVariableMatrix2fv  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix3fv  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix4fv  (const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix2x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix3x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix2x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix4x2fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix3x4fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
        GLboolean SetUniformVariableMatrix4x3fv(const GLchar *name, GLsizei count, GLboolean transpose, const GLfloat *value);
